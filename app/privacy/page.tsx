  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-stone dark:prose-invert prose-sm max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">1. Who we are</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">2. What data we collect</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">3. Cookies</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">4. Third-party services</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
          ...
          <ul className="list-disc list-inside text-stone-600 dark:text-stone-400 space-y-1.5 text-sm mt-2">
            <li><a href="https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement" className="text-teal-600 dark:text-teal-400 hover:underline" target="_blank" rel="noopener noreferrer">GitHub Privacy Statement</a></li>
            <li><a href="https://www.cloudflare.com/privacypolicy/" className="text-teal-600 dark:text-teal-400 hover:underline" target="_blank" rel="noopener noreferrer">Cloudflare Privacy Policy</a></li>
          </ul>
        </section>

        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">5. Data retention</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">6. Your rights</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">7. Children</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">8. Changes to this policy</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-stone-900 dark:text-white mb-2">9. Contact</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
