        ...
        <div className="portal-container h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-md hidden sm:block">
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-2 bg-slate-50 dark:bg-slate-800/80 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[8px] text-slate-500 dark:text-slate-400 text-sm transition-colors cursor-pointer"
              title="Search Knowledge Base (Ctrl + K)"
            >
              <div className="flex items-center gap-2.5">
                <Search className="w-4 h-4 text-[#4a90e2]" />
                <span className="text-sm">Search guides, error codes, commands...</span>
              </div>
              <kbd className="px-2 py-0.5 font-mono text-xs bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded text-slate-500 dark:text-slate-400 shadow-2xs">
                Ctrl K
              </kbd>
            </button>
          </div>
