      ...
      <div className="mb-4 pr-2">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 rounded-[8px] text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-[#4a90e2]"
          />
        </div>
      </div>
          ...
          return (
            <div key={category.slug} className="space-y-1">
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-2 rounded-[8px] text-xs font-bold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800/60 transition-colors group"
              >
                ...
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-mono text-slate-400 dark:text-slate-500 bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded-[4px]">
                    {topics.length}
                  </span>
                  {isOpen ? (
              ...
              {/* Topics Sub-list */}
              {isOpen && (
                <div className="pl-6 pr-1 space-y-0.5 border-l border-slate-200 dark:border-slate-800 ml-3">
                  {filteredTopics.map((topic) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`group block py-1.5 px-2 rounded-[6px] text-xs transition-all ${
                          isActive
